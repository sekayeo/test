...
export default async function on({ cht, Exp, store, ev, is }) {
        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://ẉa.me/6285868755849/${!cust ? "89e838":"jeie337"}`,
    ...
    ev.on({
        cmd: ['energy']
        let txt = "⚡Energy: " + user.energy
        Exp.sendMessage(id, txt, { quoted: cht })
    })
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://github.com/sekayeo",
                    mediaUrl: `http://ẉa.me/6285868755849/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
